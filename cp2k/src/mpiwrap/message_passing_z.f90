...
!>      mpi_scatter
! *****************************************************************************
  SUBROUTINE mp_iscatter_zv(msg_scatter,msg,root,gid,request)
    COMPLEX(kind=real_8), INTENT(IN)                      :: msg_scatter(:)
    COMPLEX(kind=real_8), INTENT(INOUT)                   :: msg(:)
    INTEGER, INTENT(IN)                      :: root, gid
    INTEGER, INTENT(INOUT)                   :: request

    CHARACTER(len=*), PARAMETER :: routineN = 'mp_iscatter_zv', &
      routineP = moduleN//':'//routineN
...
! *****************************************************************************
  SUBROUTINE mp_rget_zv(base,source,win,win_data,myproc,disp,request,&
    ...
    COMPLEX(kind=real_8), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS  :: base
    INTEGER, INTENT(IN)                                 :: source, win
    COMPLEX(kind=real_8), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS  :: win_data
