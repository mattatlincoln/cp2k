...
! **************************************************************************************************
  FUNCTION pointer_view_s (original, lb, ub) RESULT (view)
    REAL(kind=real_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: original, view
...
! **************************************************************************************************
  SUBROUTINE ensure_array_size_s(array, lb, ub, factor,&
    ...
    REAL(kind=real_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: array
    ...
    REAL(kind=real_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: newarray
...
! **************************************************************************************************
  SUBROUTINE mem_alloc_s (mem, n, mem_type)
    REAL(kind=real_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: mem
    INTEGER, INTENT(IN)                                :: n
