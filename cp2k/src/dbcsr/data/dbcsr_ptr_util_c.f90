...
! **************************************************************************************************
  FUNCTION pointer_view_c (original, lb, ub) RESULT (view)
    COMPLEX(kind=real_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: original, view
...
! **************************************************************************************************
  SUBROUTINE ensure_array_size_c(array, lb, ub, factor,&
    ...
    COMPLEX(kind=real_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: array
    ...
    COMPLEX(kind=real_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: newarray
...
! **************************************************************************************************
  SUBROUTINE mem_alloc_c (mem, n, mem_type)
    COMPLEX(kind=real_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: mem
    INTEGER, INTENT(IN)                                :: n
