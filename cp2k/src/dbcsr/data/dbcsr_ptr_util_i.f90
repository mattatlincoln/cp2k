...
! **************************************************************************************************
  FUNCTION pointer_view_i (original, lb, ub) RESULT (view)
    INTEGER(kind=int_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: original, view
...
!>                            write nothing
! **************************************************************************************************
  SUBROUTINE ensure_array_size_i(array, lb, ub, factor,&
       nocopy, memory_type, zero_pad)
    INTEGER(kind=int_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: array
    ...
    INTEGER(kind=int_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: newarray
...
! **************************************************************************************************
  SUBROUTINE mem_alloc_i (mem, n, mem_type)
    INTEGER(kind=int_4), DIMENSION(:), POINTER CP_COMMA_CONTIGUOUS :: mem
    INTEGER, INTENT(IN)                                :: n
