...
!> \note see block_partial_copy_a
! **************************************************************************************************
  SUBROUTINE block_partial_copy_2d1d_c(dst, dst_tr,&
       src, src_rs, src_cs, src_tr,&
       dst_r_lb, dst_c_lb, src_r_lb, src_c_lb, nrow, ncol,&
       src_offset)
    COMPLEX(kind=real_4), DIMENSION(:,:), &
...
!> \note see block_partial_copy_a
! **************************************************************************************************
  SUBROUTINE block_partial_copy_2d2d_c(dst, dst_tr,&
       src, src_tr,&
       dst_r_lb, dst_c_lb, src_r_lb, src_c_lb, nrow, ncol)
    COMPLEX(kind=real_4), DIMENSION(:,:), &
      INTENT(INOUT)                          :: dst
...
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_c(extent_out, extent_in,&
       rows, columns)
    COMPLEX(kind=real_4), DIMENSION(:), INTENT(OUT) :: extent_out
    COMPLEX(kind=real_4), DIMENSION(:), INTENT(IN)  :: extent_in
...
!   ---------------------------------------------------------------------------
#if defined(__MKL)
    CALL mkl_comatcopy('C', 'T', rows, columns, CMPLX(1.0, 0.0, real_4), extent_in, rows, extent_out, rows)
#else
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_2d1d_c(extent_out, extent_in,&
       rows, columns)
    INTEGER, INTENT(IN)                           :: rows, columns
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_1d2d_c(extent_out, extent_in,&
       rows, columns)
    COMPLEX(kind=real_4), DIMENSION(:), INTENT(OUT)            :: extent_out
    INTEGER, INTENT(IN)                           :: rows, columns
    COMPLEX(kind=real_4), DIMENSION(rows,columns), INTENT(IN)  :: extent_in
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_inplace_c(extent, rows, columns)
    INTEGER, INTENT(IN)                      :: rows, columns
...
!   ---------------------------------------------------------------------------
#if defined(__MKL)
    CALL mkl_cimatcopy('C', 'T', rows, columns, CMPLX(1.0, 0.0, real_4), extent, rows, rows)
#else
    DO r = 1 , columns
      DO c = 1 , rows
...
!   ---------------------------------------------------------------------------
    ...
    ELSE
       ...
       ub_s = ub
    ENDIF
    CALL memory_copy(dst%d%c_sp(lb:ub),src(lb_s:ub_s),data_size)
