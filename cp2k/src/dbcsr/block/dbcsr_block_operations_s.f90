...
!> \note see block_partial_copy_a
! **************************************************************************************************
  SUBROUTINE block_partial_copy_2d1d_s(dst, dst_tr,&
       src, src_rs, src_cs, src_tr,&
       dst_r_lb, dst_c_lb, src_r_lb, src_c_lb, nrow, ncol,&
       src_offset)
    REAL(kind=real_4), DIMENSION(:,:), &
...
!> \note see block_partial_copy_a
! **************************************************************************************************
  SUBROUTINE block_partial_copy_2d2d_s(dst, dst_tr,&
       src, src_tr,&
       dst_r_lb, dst_c_lb, src_r_lb, src_c_lb, nrow, ncol)
    REAL(kind=real_4), DIMENSION(:,:), &
      INTENT(INOUT)                          :: dst
...
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_s(extent_out, extent_in,&
       rows, columns)
...
!   ---------------------------------------------------------------------------
    ...
    THEN
        CALL libxsmm_transpose_oop(C_LOC(extent_out), C_LOC(extent_in), &
                                   4, rows, columns, rows, rows)
    ELSE
#endif
#if defined(__MKL)
    CALL mkl_somatcopy('C', 'T', rows, columns, 1.0_real_4, extent_in, rows, extent_out, rows)
#else
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_2d1d_s(extent_out, extent_in,&
       rows, columns)
#if defined(__LIBXSMM)
    USE libxsmm
#endif
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_1d2d_s(extent_out, extent_in,&
       rows, columns)
#if defined(__LIBXSMM)
    USE libxsmm
#endif
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_inplace_s(extent, rows, columns)
    INTEGER, INTENT(IN)                      :: rows, columns
...
!   ---------------------------------------------------------------------------
#if defined(__MKL)
    CALL mkl_simatcopy('C', 'T', rows, columns, 1.0_real_4, extent, rows, rows)
#else
    DO r = 1 , columns
      DO c = 1 , rows
