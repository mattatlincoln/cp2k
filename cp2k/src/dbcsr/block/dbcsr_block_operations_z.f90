...
!> \note see block_partial_copy_a
! **************************************************************************************************
  SUBROUTINE block_partial_copy_2d1d_z(dst, dst_tr,&
       src, src_rs, src_cs, src_tr,&
       dst_r_lb, dst_c_lb, src_r_lb, src_c_lb, nrow, ncol,&
       src_offset)
    COMPLEX(kind=real_8), DIMENSION(:,:), &
...
!> \note see block_partial_copy_a
! **************************************************************************************************
  SUBROUTINE block_partial_copy_2d2d_z(dst, dst_tr,&
       src, src_tr,&
       dst_r_lb, dst_c_lb, src_r_lb, src_c_lb, nrow, ncol)
    COMPLEX(kind=real_8), DIMENSION(:,:), &
      INTENT(INOUT)                          :: dst
...
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_z(extent_out, extent_in,&
       rows, columns)
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_2d1d_z(extent_out, extent_in,&
       rows, columns)
#if defined(__LIBXSMM)
    USE libxsmm
#endif
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_copy_1d2d_z(extent_out, extent_in,&
       rows, columns)
#if defined(__LIBXSMM)
    USE libxsmm
#endif
...
!> \param[in] columns input matrix size
! **************************************************************************************************
  CP_MKL_PURE SUBROUTINE block_transpose_inplace_z(extent, rows, columns)
    INTEGER, INTENT(IN)                      :: rows, columns
...
!   ---------------------------------------------------------------------------
#if defined(__MKL)
    CALL mkl_zimatcopy('C', 'T', rows, columns, CMPLX(1.0, 0.0, real_8), extent, rows, rows)
#else
    DO r = 1 , columns
      DO c = 1 , rows
